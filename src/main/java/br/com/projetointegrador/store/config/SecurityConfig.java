...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(HttpMethod.GET, "/client/getInfo/{uuid}").permitAll()
                .requestMatchers(HttpMethod.POST, "/order/register").permitAll()
                .requestMatchers(HttpMethod.GET, "/order/myOrders/{uuid}").permitAll()
                .requestMatchers(HttpMethod.GET, "/order/listingAllOrders").permitAll()
                .requestMatchers(HttpMethod.GET, "/order/getOrderStatus/{uuid}").permitAll()
                .requestMatchers(HttpMethod.PUT, "/order/changeStatusOrder/{uuid}").permitAll()
