...
INSERT INTO USERS(id, name, email, cpf, password, role, active, created_at, updated_at) VALUES
...
INSERT INTO PRODUCTS(id, name, description, price, rate, created_at, updated_at) VALUES
('7f69ead0-dfdb-4829-b6ef-f55365502243', 'Iphone 15', 'Smartphone da marca Apple', 10000, 4.0, now(), now()),
('d6bb38cc-bd6d-4cf8-9db5-240c75363d60', 'Galaxy S23', 'Smartphone da marca Samsung', 4599, 4.5, now(), now());